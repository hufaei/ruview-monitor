...
class WiFiDensePoseApp {
  ...
  initializeEnhancements() {
    ...
    // The remote dashboard supplies navigation, diagnostics and onboarding.
    // Keep the official sensing renderer, but do not duplicate those overlays.
    if (new URLSearchParams(window.location.search).get('embedded') === '1') {
      document.body.classList.add('remote-dashboard-embedded');
