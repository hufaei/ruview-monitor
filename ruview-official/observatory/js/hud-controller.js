...
const SCENARIO_DESCRIPTIONS = {
  auto:              '自动轮播全部感知场景。',
  empty_room:        '无人区域的基线校准，用于识别环境本身的信号波动。',
  single_breathing:  '根据 WiFi 信号微小变化演示心率和呼吸估计。',
  two_walking:       '利用 CSI 多路特征分离演示多人同时追踪。',
  fall_event:        '根据姿态突变和加速度特征演示跌倒事件检测。',
  sleep_monitoring:  '演示睡眠期间的呼吸节律与呼吸暂停事件。',
  intrusion_detect:  '不使用摄像头，仅用射频变化进行被动区域监测。',
  gesture_control:   '用 DTW（动态时间规整）匹配手臂运动特征。',
  crowd_occupancy:   '根据聚合 CSI 方差估计房间内的人数。',
  search_rescue:     '用 WiFi-MAT 多基地模式演示穿墙生命迹象搜救。',
  elderly_care:      '连续分析步态，演示行动能力变化检测。',
  fitness_tracking:  '根据人体运动学演示动作分类与次数统计。',
  security_patrol:   '用无摄像头运动热图演示多区域存在巡检。',
};
